                ...
                <div className="flex flex-col gap-40">
                    ...
                    {projects.map((project, index) => (
                        ...
                        <motion.div
                            ...
                            className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ${index % 2 !== 0
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Link
                                    ...
                                    className="inline-block border border-black px-8 py-4 rounded-full hover:bg-black hover:text-white transition-all duration-500"
                                >
                                    View Project
                                </Link>
