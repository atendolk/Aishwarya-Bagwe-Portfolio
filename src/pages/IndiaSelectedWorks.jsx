...
const images = Object.values(
  import.meta.glob(
    "../assets/projects/professional/india-selected-works/page-*.png",
    { eager: true, import: "default" }
  )
).sort((a, b) => a.localeCompare(b, undefined, { numeric: true }))

function IndiaSelectedWorks() {
  return (
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          {images.map((image, index) => (
            <img
              key={index}
              src={image}
              alt={`India Selected Works - ${index + 1}`}
              loading="lazy"
...
export default IndiaSelectedWorks